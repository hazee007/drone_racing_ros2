...
def generate_launch_description():
     ...
     gate_nodes_height = create_gates_random_height()
     
     print(gate_nodes_height)
     ...
     return LaunchDescription([
          ...
          *gates_nodes,
          ...
          # Add the gate different height gate - spawn entity list
	     *gate_nodes_height,
          ...
          Node(
               ...
               output='screen',
               arguments=[pallet_sdf_path, '-0.4', '14', '1', '0.01', 'pallet_1']
          ),
          Node(
               package='tello_gazebo',
               executable='inject_entity.py',
               output='screen',
               arguments=[pallet_sdf_path, '0.41', '14', '1', '0.01',  'pallet_2']
          ),
          Node(
               package='tello_gazebo',
               executable='inject_entity.py',
               output='screen',
               arguments=[stop_sdf_path, '0', '14.8', '0', '0.01', 'stop_1']
          ),
...
def create_gates_random_height():
     colors = ['green','green']
     shapes = ['circle', 'square']
     height = ['tall','short']
     gates_nodes = []
     ...
     for gate_n, location in enumerate(gates_locations):
          ...
          model_color_folder = f'{shape}_gate_{color}_{height}'
               
          print('model_color_folder',model_color_folder)
